        ...
        >
          ...
          >
            ...
            <div className="text-center mb-6">
              <span className="text-5xl mb-2 block animate-bounce select-none">📜</span>
              <h3 className="text-3xl text-[#FF9F1C] drop-shadow-sm" style={{ fontFamily: "var(--font-cherry)" }}>
                Nhiệm Vụ Ngày
              </h3>
            ...
            <div className="space-y-4">
              {quests.map((quest) => {
                ...
                return (
                  <div key={quest.id} className="bg-white border-2 border-zinc-100 p-4 rounded-[1.5rem] flex flex-col gap-3 shadow-sm">
                    <div className="flex justify-between items-start">
                      <h4 className="font-bold text-zinc-700 font-rounded text-[15px]">{quest.title}</h4>
