        ...
        >
          ...
          >
            <div className="w-28 h-28 bg-[#FF7096] rounded-[2rem] rotate-12 flex items-center justify-center shadow-[0_8px_0_0_#C7486B] mb-8 border-4 border-white">
              <span className="text-6xl text-white -rotate-12 font-bold" style={{ fontFamily: "var(--font-rounded)" }}>あ</span>
            </div>
            <h1 className="text-3xl text-[#FF7096] tracking-wider flex items-center gap-2 drop-shadow-sm" style={{ fontFamily: "var(--font-cherry)" }}>
              Nihongo Card
            ...
            {interactionNeeded && (
              <motion.p 
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ repeat: Infinity, duration: 1.2, repeatType: "reverse" }}
