...
export function FlashcardBack({
  ...
  return (
    ...
    */
    <div className="w-full max-w-md h-[400px] bg-[#F0FAF5] rounded-xl border-4 border-[#A0E8D5] shadow-[0_10px_0_0_#A0E8D5] relative overflow-hidden flex flex-col">
      {/* KHU VỰC CUỘN ĐƯỢC (Header + Kanji Info) */}
      <div className="flex-1 overflow-y-auto hide-scrollbar p-6 pb-[140px] flex flex-col">
      ...
      {/* KHỐI 3: CÂU VÍ DỤ (Absolute ghim cứng ở đáy) */}
      <div className="absolute bottom-4 left-4 right-4 z-10 pt-4 border-t-4 border-[#A0E8D5] bg-white/95 backdrop-blur-sm rounded-2xl p-4 border-dashed text-center shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
