        ...
        <div className="w-full h-full overflow-y-auto snap-y snap-mandatory scroll-smooth scrollbar-none relative">
          ...
          >
            ...
            {userStats.equippedFurniture?.wall && (() => {
              const item = GACHA_POOL.find((i) => i.id === userStats.equippedFurniture.wall);
              ...
              return (
                ...
                >
                  <img
                    src={getFurnitureImg(userStats.equippedFurniture.wall)}
                    alt="Wall Furniture"
            ...
            {userStats.equippedFurniture?.corner && (() => {
              const item = GACHA_POOL.find((i) => i.id === userStats.equippedFurniture.corner);
              const customStyle = item?.roomStyle;
              return (
                <div
                ...
                >
                  <img
                    src={getFurnitureImg(userStats.equippedFurniture.corner)}
            ...
            {userStats.equippedFurniture?.floor && (() => {
              const item = GACHA_POOL.find((i) => i.id === userStats.equippedFurniture.floor);
              ...
              return (
                ...
                >
                  <img
                    src={getFurnitureImg(userStats.equippedFurniture.floor)}
                    alt="Floor Furniture"
                    className="max-w-full max-h-full object-contain"
                  />
                </div>
                  ...
                  <div className="grid grid-cols-5 bg-[#8C6D58]/10 p-0.5 rounded-2xl gap-0.5 mb-2 border border-[#8C6D58]/20">
                    {(["trangbi", "decor", "meme", "voice", "theme"] as const).map((tab) => (
                      <button
                        ...
                        title={
                          tab === "trangbi" ? "Trang bị" :
                            tab === "decor" ? "Đồ trang trí" :
                              tab === "meme" ? "Thẻ Meme" :
                                tab === "voice" ? "Giọng nói" : "Chủ đề"
                        }
                      >
