...
export function ProfileTab() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 max-w-2xl px-4 py-6">
      ...
      <div className="bg-[#FFFDF9] rounded-[2.5rem] p-6 border-4 border-[#FFE2D1] shadow-[0_8px_0_0_#FFE2D1] flex flex-col gap-4">
        ...
        {/* Danh sách 7 ngày */}
        <div className="flex md:grid md:grid-cols-7 gap-2 overflow-x-auto hide-scrollbar snap-x snap-mandatory py-1 w-full">
          {weekDays.map((day) => {
